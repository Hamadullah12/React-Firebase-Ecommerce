...
const HomePageProductCard = () => {
  ...
  const { getAllProduct, loading } = context; // Ensure it's an array
                    ...
                    <div className="h-full border border-gray-300 rounded-xl overflow-hidden shadow-md cursor-pointer">
                      ...
                      <div className="p-6">
                        ...
                        <div className="flex justify-center">
                          <button className="bg-fuchsia-950 hover:bg-pink-600 w-full text-white py-[4px] rounded-lg font-bold">
                            Add To Cart
                          </button>
                        </div>
                      </div>
