          ...
          <div className="flex flex-wrap mb-24 -mx-4">
            ...
            <div className="w-full px-4 md:w-1/2">
              <div className="lg:pl-20">
                <div className="mb-6 ">
                  <h2 className="max-w-xl mb-6 text-xl font-semibold leading-loose tracking-wide  md:text-2xl dark:text-gray-600">
                  ...
                  <p className="inline-block text-2xl font-semibold text-gray-700 dark:text-gray-600 ">
                ...
                <div className="mb-6 " />
                <div className="flex flex-wrap items-center mb-6">
                  <button className="w-full px-4 py-3 text-center bg-fuchsia-950 text-white  hover:bg-pink-600 hover:text-gray-100 rounded-xl">
                    Add to cart
                  </button>
                </div>
              </div>
